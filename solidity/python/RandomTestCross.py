...
def formulaTest(balance1, weight1, balance2, weight2, amount):
    resultSolidityPort = FormulaSolidityPort.calculateCrossReserveReturn(balance1, weight1, balance2, weight2, amount)
    resultNativePython = FormulaNativePython.calculateCrossReserveReturn(balance1, weight1, balance2, weight2, amount)
