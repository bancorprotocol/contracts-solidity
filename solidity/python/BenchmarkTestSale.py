...
def formulaTest(supply, balance, weight, amount):
    resultSolidityPort = FormulaSolidityPort.saleTargetAmount(supply, balance, weight, amount)
    resultNativePython = FormulaNativePython.saleTargetAmount(supply, balance, weight, amount)
