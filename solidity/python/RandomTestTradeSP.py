...
def formulaTest(supply, balance, ratio, amount):
    amount1 = FormulaSolidityPort.calculateSaleReturn(supply, balance, ratio, amount)
    amount2 = FormulaSolidityPort.calculatePurchaseReturn(supply - amount, balance - amount1, ratio, amount1)
