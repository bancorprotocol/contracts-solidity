...
'''
SCALED_EXP_0P5 = 0x1a61298e1;
SCALED_VAL_0P5 = 0x80000000;
...
'''
CEILING_LN2_MANTISSA = 0xb17217f8;
FLOOR_LN2_MANTISSA   = 0x2c5c85fdf473de6af278ece600fcbda;
FLOOR_LN2_EXPONENT   = 122;
...
def calculateBestPrecision(_baseN, _baseD, _expN, _expD):
    maxVal = lnUpperBound(_baseN, _baseD) * _expN;
    lo = MIN_PRECISION;
    hi = MAX_PRECISION;
    while (lo + 1 < hi):
        mid = (lo + hi) / 2;
