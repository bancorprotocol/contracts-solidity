...
def formulaTest(supply, balance1, weight1, balance2, weight2, amount0):
    ...
    amount4 = FormulaSolidityPort.purchaseTargetAmount(supply, balance1 + amount1 - amount3, weight1, amount3 - amount1)
    amount5 = FormulaSolidityPort.saleTargetAmount(supply + amount4, balance2 + amount2, weight2, amount4)
    ...
    if after > before:
        ...
        error.append('amount5  = {}'.format(amount5))
