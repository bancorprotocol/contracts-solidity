...
def formulaTest(supply, balance1, weight1, balance2, weight2, amount0):
    amount1 = FormulaSolidityPort.liquidateReserveAmount(supply, balance1, weight1 + weight2, amount0)
    amount2 = FormulaSolidityPort.liquidateReserveAmount(supply, balance2, weight1 + weight2, amount0)
    amount3 = FormulaSolidityPort.purchaseTargetAmount(supply - amount0, balance1 - amount1, weight1, amount1)
    amount4 = FormulaSolidityPort.purchaseTargetAmount(supply - amount0 + amount3, balance2 - amount2, weight2, amount2)
