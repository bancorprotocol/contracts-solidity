...
def formulaTest(supply, balance1, weight1, balance2, weight2, amount0):
    ...
    amount4 = FormulaSolidityPort.calculateCrossConnectorReturn(balance1 + amount1 - amount3, weight1, balance2 + amount2, weight2, amount3 - amount1)
    before, after = amount2, amount4
    if after > before:
