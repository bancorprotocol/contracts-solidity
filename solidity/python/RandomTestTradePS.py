...
def formulaTest(supply, balance, weight, amount):
    amount1 = FormulaSolidityPort.purchaseRate(supply, balance, weight, amount)
    amount2 = FormulaSolidityPort.saleRate(supply + amount1, balance + amount, weight, amount1)
