...
def formulaTest(supply, balance, weights, amount):
    resultSolidityPort = FormulaSolidityPort.fundCost(supply, balance, weights, amount)
    resultNativePython = FormulaNativePython.fundCost(supply, balance, weights, amount)
