...
*/
contract BancorConverter is IBancorConverter, SmartTokenController, Managed, ContractIds, FeaturesIds {
    ...
    */
        ...
        validMaxConversionFee(_maxConversionFee)
    {
        ...
        if (features != address(0))
            features.enableFeatures(FeaturesIds.CONVERTER_CONVERSION_WHITELIST, true);
