...
import "../BancorNetworkUpgradeable.sol";
import "./TestConverters.sol";

contract TestBancorNetworkUpgradeable is BancorNetworkUpgradeable {
    OldConverter private oldConverter;
    NewConverter private newConverter;

    constructor(uint256 _amount, uint256 _fee) public {
        BancorNetworkUpgradeable.initialize(IContractRegistry(address(1)));
