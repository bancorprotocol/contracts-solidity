...
*/
contract BancorNetwork is IBancorNetwork, TokenHolder, ContractIds, FeaturesIds {
    ...
    */
    function checkWhitelist(IBancorConverter _converter, address _for, IContractFeatures _features) private view {
        ...
        if (!_features.isSupported(_converter, FeaturesIds.CONVERTER_CONVERSION_WHITELIST))
            return;
