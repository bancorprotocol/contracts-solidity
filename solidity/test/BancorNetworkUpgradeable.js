...
const { constructorBancorNetwork } = require('./helpers/Constructors');
const TestBancorNetworkUpgradeable = contract.fromArtifact('TestBancorNetworkUpgradeable');
...
describe('BancorNetwork', () => {
    ...
    describe('Settings', () => {
        beforeEach(async () => {
            bancorNetwork = await constructorBancorNetwork(contractRegistry.address);
        });
        ...
        it('verifies valid ether token registration', async () => {
            ...
            const bancorNetwork1 = await constructorBancorNetwork(contractRegistry.address);
    ...
    describe('Conversions', () => {
        beforeEach(async () => {
            network = await TestBancorNetworkUpgradeable.new(0, 0);
