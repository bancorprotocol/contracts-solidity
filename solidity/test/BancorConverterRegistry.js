...
contract('BancorConverterRegistry', function(accounts) {
    ...
    describe('create converters internally:', function() {
        ...
        before(async function() {
            ...
            await converterRegistry.newLiquidityPool(LIQUIDITY_POOL_TYPE_CLASSIC, 'SmartToken3', 'ST4', 18, 0, [ETH_RESERVE_ADDRESS, erc20Token1.address], [0x4000, 0x4100], [1000000, 1000000], {value: 1000000});
            await converterRegistry.newLiquidityPool(LIQUIDITY_POOL_TYPE_CLASSIC, 'SmartToken4', 'ST5', 18, 0, [erc20Token1.address, erc20Token2.address], [0x5100, 0x5200], [1000000, 1000000], {value:       0});
            await converterRegistry.newLiquidityPool(LIQUIDITY_POOL_TYPE_CLASSIC, 'SmartToken5', 'ST6', 18, 0, [erc20Token2.address, ETH_RESERVE_ADDRESS], [0x6200, 0x6000], [1000000, 1000000], {value: 1000000});
